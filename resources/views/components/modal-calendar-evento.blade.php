        ...
        <div class="p-4" x-show="event">
                ...
                <div class="flex-1">
                 <P class="text-2xl font-extrabold" x-text="event.title"></P>
                    <div class="flex items-center gap-2">
                        <span class="bg-blue-100 text-blue-500 rounded-xl px-2 py-1" x-text="event.extendedProps.tipo"></span>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="grid grid-cols-4 gap-4 items-center">
                    <div class="w-10 h-10 bg-gray-200 p-2 rounded-lg inline-flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
