    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <span class="badge {{ $esActualizacion ? 'badge-actualizado' : 'badge-nuevo' }}">
                {{ $esActualizacion ? 'Actualizacion de solicitud a Servicios Generales' : 'Solicitud de servicio a Servicios Generales' }}
            </span>
        </div>
        ...
        <div class="body">
            ...
            <div class="section">
                <div class="section-title">Notas para Servicios Generales</div>
                <div class="notas-cta">
                    <p>{{ $evento->notas_servicios }}</p>
                </div>
            </div>
