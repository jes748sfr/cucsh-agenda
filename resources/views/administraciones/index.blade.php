<x-app-layout>
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500 mt-1">Ámbitos organizacionales que agrupan a los organizadores.</p>
    </div>
        ...
        <x-table>
            ...
            <tbody>
                @forelse ($administraciones as $admin)
                    <x-table-row striped
                        @click="if (!$event.target.closest('a, button')) window.location.href = '{{ url('administraciones/' . $admin->id) }}'"
